...
export default class GameScene extends Phaser.Scene {
    ...
    init (data) { 
        console.log("this is the GameScene");
    ...
    update () {
        ...
        //call WASD key checks from bullets class to determine bullet direction, pass keys and player object to bullets update
        this.bullets.update(this.WASDkeys, this.player);
